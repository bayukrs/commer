...
public class ReportImpl implements ReportService {
    ...
    public Map report(Long idPost, Principal principal, ReportPost rp) {
        try{
            ...
            emailSender.sendAsync(rps.getId_user().getUsername(), "Commit - Post Report", template);
    ...
    public Map reportComment(Long idKomentar, Principal principal, ReportComment reportComment) {
        try {
            ...
            emailSender.sendAsync(rpc.getId_user().getUsername(), "Commit - Comment Report", template);
    ...
    public Map reportUser(Long id_user, Principal principal, ReportUser reportUser) {
        try {
            ...
            emailSender.sendAsync(rps.getId_user().getUsername(), "Commit - User Report", template);
